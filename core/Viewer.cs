...
public static class Viewer
{
    ...
    {
        _projectionMatrix = Matrix4.CreatePerspectiveFieldOfView((_fieldOfView / 180f) * MathF.PI, (float)NlcEngineGame.Profile.BufferWidth / NlcEngineGame.Profile.BufferHeight, _depthNear, _depthFar);
    }
